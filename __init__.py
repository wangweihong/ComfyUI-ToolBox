...
from .nodes.video_compare_node import NODE_CLASS_MAPPINGS as video_compare_nodes_mapping
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "ParallelVideoComparison": "toolbox-video-comparison",
}
